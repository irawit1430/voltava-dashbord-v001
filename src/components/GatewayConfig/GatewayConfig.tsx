...
export default function GatewayConfig({
  ...
  useEffect(() => {
    ...
    const generatePacket = () => {
      ...
      let pkt = '';
      if (selectedGateway.protocol === 'modbus-rtu' || selectedGateway.protocol === 'modbus-tcp') {
          ...
          {isAdding ? (
            ...
            <div className="glass-panel gw-form-container">
              <div className="gw-form-header">
                ...
                <button onClick={() => setIsAdding(false)} className="gw-close-btn" aria-label="Close form">
                  <X size={16} />
                </button>
              </div>
