...
describe('GatewayConfig Component', () => {
  const mockDevices: Device[] = [
    {
      id: 'dev-1', name: 'Device 1', model: 'Model A', firmware: 'v1.0', type: 'bms', status: 'online', owner: 'O1',
      location: { lat: 0, lng: 0, city: 'C1' }, telemetry: { voltage: 12, current: 1, temp: 25, soc: 100, soh: 100, lastUpdated: '12:00', faults: [] }
    }
  ];
