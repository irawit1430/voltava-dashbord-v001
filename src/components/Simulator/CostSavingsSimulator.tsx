...
export default function CostSavingsSimulator() {
  ...
  const arbitrageSavingsPerDay =
    dailyArbitrageKwh * (peakTariff - offPeakTariff / roundTripEfficiency);
  ...
  const chartData = [
    {
      name: 'Unmanaged Bill',
      DemandCharges: basePeakLoad * demandChargeRate,
      EnergyCost: 245000,
    },
    {
      name: 'Voltava Optimized',
      DemandCharges: peakLimit * demandChargeRate,
      EnergyCost: 245000 - monthlyArbitrageINR,
    },
  ];
    ...
    <div style={styles.container}>
      ...
      <div className="glass-panel" style={styles.bannerBox}>
        ...
        <h3 style={styles.bannerTitle}>
          BESS Peak Shaving & Arbitrage Calculator
        </h3>
        <p style={styles.bannerDesc}>
          Simulate battery integration. BESS absorbs energy during low-tariff
          off-peak times (e.g. night/early morning) and discharges to shave
          expensive demand spikes and offset high peak-hour grid rates.
        </p>
      </div>
        ...
        <div className="glass-panel" style={styles.sliderPanel}>
          ...
          <div style={styles.controlGroup}>
            <label style={styles.sliderLabel}>
              Indian Utility DISCOM Tariff Model
            </label>
            <select
          ...
          <div style={styles.controlGroup}>
            ...
            />
            <span style={styles.sliderRangeHint}>
              50 kWh to 500 kWh cabinet
            </span>
          </div>
          ...
          <div style={styles.controlGroup}>
            <div style={styles.sliderValueRow}>
              ...
              <span
                style={{ ...styles.sliderValue, color: 'var(--accent-cyan)' }}
              >
                {peakLimit} kW
              </span>
            </div>
            ...
            />
            <span style={styles.sliderRangeHint}>
              Unmanaged Peak: {basePeakLoad} kW
            </span>
          </div>
          ...
          <div
            style={{
              ...styles.tariffsRow,
              display: selectedDiscom === 'custom' ? 'grid' : 'none',
            }}
          >
            <div style={styles.controlGroup}>
          ...
          <div style={styles.infoFooter}>
            ...
            />
            <span>
              CapEx assumes LFP battery cell chemistry @ ₹13,500/kWh inclusive
              of inverters.
            </span>
          </div>
        </div>
        ...
        <div style={styles.resultsWrapper}>
          ...
          <div style={styles.resultsGrid}>
            <div className="glass-panel" style={styles.resultCard}>
              ...
              <span
                style={{ ...styles.resultVal, color: 'var(--accent-green)' }}
              >
            ...
            <div className="glass-panel" style={styles.resultCard}>
              ...
              <span style={styles.resultMeta}>
                Payback: <b>{paybackYears} Years</b>
              </span>
            </div>
          </div>
          ...
          <div className="glass-panel" style={styles.chartPanel}>
            ...
            >
              Shaving peak demand reduces contract demand charges. Time-of-Use
              (ToU) arbitrage cuts active energy charges.
            </p>
              ...
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  <Bar
                    ...
                    name="Demand Charges (Contract kW)"
                    fill="var(--accent-red)"
                    stackId="a"
                  />
                  <Bar
                    dataKey="EnergyCost"
                    name="Energy charges (kWh ToU)"
