...
describe('Navbar Component', () => {
  ...
  it('opens notifications dropdown when bell icon is clicked', () => {
    ...
    expect(
      screen.getByRole('dialog', { name: /system notifications/i })
    ).toBeInTheDocument();
  ...
  it('calls onSelectDevice when a notification is clicked', () => {
    ...
    const faultNotification = screen.getByRole('listitem', {
      name: /view details for device 3/i,
    });
    ...
    expect(
      screen.queryByRole('dialog', { name: /system notifications/i })
